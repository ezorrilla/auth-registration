...
public class AppConstant {
  ...
  public static final String NUMBER_FORMAT_ERROR_MESSAGE = "number format is invalid.";
  ...
  public static final String PATTERN_EMAIL = "^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Z|a-z]{2,6}$";
  public static final String PHONE_NUMBER_PATTERN = "^(\\+\\d{1,3}[-.\\s]?\\d{1,14}|\\d{1,14})$";;
